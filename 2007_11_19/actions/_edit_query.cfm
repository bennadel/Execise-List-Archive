...
<cfif REQUEST.Attributes.Submitted>
	...
	<!--- Map the errors errors to user friendly messages. --->
	<cfset REQUEST.Errors.AddMessageIfError( "NameExistence", "Please enter a name" ) />
	<cfset REQUEST.Errors.AddMessageIfError( "NameLength", "The name must be 100 characters or less" ) />
